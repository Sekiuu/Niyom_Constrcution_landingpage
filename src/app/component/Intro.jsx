...
function Intro() {
    return (
        <section className='w-full md:aspect-video aspect-square overflow-hidden'>
            <Image
            ...
            <div className="absolute md:aspect-video aspect-square inset-0 flex items-center justify-center flex-col text-white">
                <div className=' lg:text-5xl md:text-4xl  max-md:text-2xl font-bold pt-20'>บริษัท นิยมคอนสตรัคชั่น 
